...
public class RecycleAdapter_MenuListMealSelect extends RecyclerView.Adapter<RecycleAdapter_MenuListMealSelect.MyViewHolder> {

    Context context;
    View itemView;
    private ImageLoader imageLoader;
    ImageButton btn_meal_remove;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            //btn_add_to_order = (Button) view.findViewById(R.id.btn_add_to_order);
    ...
    public RecycleAdapter_MenuListMealSelect(Context context, List<Meal> mealList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_meal_select, parent, false);
...
*/
        ...
        btn_meal_remove = (ImageButton) itemView.findViewById(R.id.btn_meal_remove);
        btn_meal_remove.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                db.deleteMeal(meal);
                setItems(db.getAllMeals());
                notifyDataSetChanged();

                CommonMethods.displaySnackbar(v, "Meal "+ meal.getName() +" Removed");
            }
        });
